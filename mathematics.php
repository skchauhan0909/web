      ...
      <ul class="nav navbar-nav">
        ...
        <li  class="active" class="dropdown">
          ...
          <ul class="dropdown-menu">
			...
			<li class="active"><a href="mathematics.php">MATHEMATICS</a></li>
...
<center><h1><b>-- MATHEMATICS --</b></h1></center><br>
<div class="container-fluid" id="div5">
<div class="container">
<img src="./subjects/mathematics.jpg" height="600px" width="1080px">
</div></div></div>
