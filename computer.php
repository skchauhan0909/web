      ...
      <ul class="nav navbar-nav">
        ...
        <li class="active" class="dropdown">
          ...
          <ul class="dropdown-menu">
			...
			<li class="active"><a href="computer.php">COMPUTER SCIENCE</a></li>
          </ul>
        </li>
...
<center><h1><b>-- COMPUTER SCIENCE --</b></h1></center><br>
<div class="container-fluid" id="div5">
<div class="container">
<img src="./subjects/computer.jpg" height="600px" width="1080px">
</div></div></div>
